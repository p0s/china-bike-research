...
test('the 50-approach audit retains new live gaps until the campaign is extended', () => {
  ...
  const newTargets = ['airwolf-yf-r003', 'evolve-cima-road', 'mondince-fm316', 'seraph-tt-x68-new-udh', 'twitter-gravel-v3', 'velobuild-cx-002-2023'];
  assert.equal(report.counts.uncovered_current_fields, 11);
