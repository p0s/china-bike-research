...
// The 256-row unified catalog with production project-base links, typed filters,
// and Build handoff measured 909,131 bytes and 7,013 elements on 2026-08-29.
...
// data fetch.
const performanceBudget = { home_html_bytes: 920_000, home_elements: 7_100 };
const performance = {
